...
import mx.gob.imss.dpes.notificacionback.restclient.ReporteResumenCartaInstruccionClient;
/**
 *
 * @author osiris.hernandez
 */
@Provider
public class ReadReporteResumenCartaInstruccionService extends ServiceDefinition<NotificacionCorreo, NotificacionCorreo> {

  @Inject
  @RestClient
  private ReporteResumenCartaInstruccionClient client;
  ...
  public Message<NotificacionCorreo> execute(Message<NotificacionCorreo> request) throws BusinessException {
    ...
    if (respuesta.getStatus() == 200) {
      ...
      adjunto.setNombreAdjunto("ReporteResumenCartaInstruccion.pdf");
