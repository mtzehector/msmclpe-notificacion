...
import mx.gob.imss.dpes.notificacionback.restclient.ReporteCapacidadCreditoClient;
 ...
 */
@Provider
public class ReadReporteCartaCapacidadService extends ServiceDefinition<NotificacionCorreo, NotificacionCorreo> {

  @Inject
  @RestClient
  private ReporteCapacidadCreditoClient client;
  ...
  public Message<NotificacionCorreo> execute(Message<NotificacionCorreo> request) throws BusinessException {
    ...
    if (respuesta.getStatus() == 200) {
      ...
      adjunto.setNombreAdjunto("ReporteCapacidadCredito.pdf");
